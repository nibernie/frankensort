...
int GPeak::fPeakCounter=0;

GPeak::GPeak(Double_t cent,Double_t xlow,Double_t xhigh,Option_t *opt)
      : TF1(Form("photopeakbg_%i",fPeakCounter),GRootFunctions::PhotoPeakBG,xlow,xhigh,7,1,EAddToList::kNo),
        fBGFit(Form("background_%i",fPeakCounter),GRootFunctions::StepBG,xlow,xhigh,6,1,EAddToList::kNo)  {
  fPeakCounter++;
  Clear("");
...
GPeak::GPeak(Double_t cent,Double_t xlow,Double_t xhigh,TF1 *bg,Option_t *opt)
  ...
  if(bg) {
    ...
    fBGFit = TF1("BGFit",GRootFunctions::StepBG,xlow,xhigh,10,1,EAddToList::kNo);
  }
...
GPeak::GPeak()
      : TF1(Form("photopeakbg_%i",fPeakCounter),GRootFunctions::PhotoPeakBG,0,1000,10,1,EAddToList::kNo),
        fBGFit(Form("background_%i",fPeakCounter),GRootFunctions::StepBG,0,1000,10,1,EAddToList::kNo) {
  fPeakCounter++;
